...
This will call create_csv_from_doc in bug_scrub_to_csv module
'''
...
def task(Env, input_filename, output_filename):
    """
    Accepts a bug scrub file from GDC in unicode-8) and produces a
    CSV with relevant information
